...
<head>
    ...
    <title>Profil Saya - Tokopedia</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <nav class="hidden md:flex space-x-6">
                    <a href="#" class="text-gray-600 hover:text-gray-900 text-sm">Tentang Tokopedia</a>
                    ...
                    <a href="#" class="text-gray-600 hover:text-gray-900 text-sm">Tokopedia Care</a>
                </nav>
            </div>
        </div>
        ...
        <div class="border-t bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between h-20">
                    <!-- Logo -->
                    <div class="flex items-center">
                        <div class="text-3xl font-bold primary-pink">tokopedia</div>
                ...
                <div class="bg-white rounded-lg shadow-sm p-4 mb-6">
                    ...
                    <div class="flex items-center justify-between mb-4">
                        <div class="flex items-center">
                            ...
                            <span class="text-gray-700">Tokopedia Card</span>
                        </div>
