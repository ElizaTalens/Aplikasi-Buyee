...
                        <a class="nav-link text-white" href="#" onclick="logout(event)" style="opacity: 0.8;">
...
    // BATALKAN PERILAKU DEFAULT BROWSER (Mencegah GET Request)
    if (event) {
        event.preventDefault(); 
    }
    
    if (confirm('Apakah Anda yakin ingin keluar?')) {
        let form = document.getElementById('logout-form-admin');
        
        // Jika belum ada, buat form POST secara dinamis
        if (!form) {
            form = document.createElement('form');
            form.setAttribute('id', 'logout-form-admin');
            form.setAttribute('method', 'POST');
            // Pastikan URL-nya adalah route('logout')
