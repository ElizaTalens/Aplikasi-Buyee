<footer class="bg-gray-100 pt-12 pb-8 border-t border-gray-200">
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-5 gap-10">
    {{-- brand --}}
    <div class="space-y-4">
      <div class="flex items-center gap-3">
        <img src="{{ asset('images/logo.png') }}" class="h-30 w-auto" alt="Buyee">
      </div>
      <div class="flex items-center gap-3">
        <a href="" target="_blank" rel="noopener" aria-label="Instagram"
          class="h-10 w-10 rounded-full bg-white shadow grid place-items-center text-black-500 hover:text-grey-500 hover:bg-gray-100">
...
<footer class="bg-gray-100 pt-12 pb-8 border-t border-gray-200">
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-5 gap-10">
    ...
    <div class="space-y-4">
      <div class="flex items-center gap-3">
        <img src="{{('images/logo.png') }}" class="h-30 w-auto" alt="Buyee">
      </div>
      <div class="flex items-center gap-3">
        <a href="" target="_blank" rel="noopener" aria-label="Instagram"
          class="h-10 w-10 rounded-full bg-white shadow grid place-items-center text-black-500 hover:text-grey-500 hover:bg-gray-100">
